...
public class ServicceFormController implements Initializable {
    ...
    private void setProfileAndValues() {
        ...
        try {
            List<String> nameList = ServiceCenterRepo.getName();
            if(nameList.size() < 1){
        ...
        try {
            List<String> nameList = ServiceCenterRepo.getPhone();
            if(nameList.size() < 1){
    ...
    private void setTable() {
        ...
        try {
            List<ServiceTable> allDetail = ServiceRepo.getAllDetail();
    ...
    private void setComboServiceCenter() {
        ObservableList<String> obList = FXCollections.observableArrayList();
        try {
            List<String> idList = ServiceCenterRepo.getId();
    ...
    private void setComboServiceType() {
        ObservableList<String> obList = FXCollections.observableArrayList();
        try {
            List<String> typeList = ServiseScheduleRepo.getType();
    ...
    public void txtSearchOnAction(ActionEvent actionEvent) {
        ...
        try {
            Service service = ServiceRepo.getAll();
    ...
    public void btnSaveOnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            String currentPaymentId1 = PaymentRepo.getCurrentId();
            String nextId = PaymentRepo.getNextId(currentPaymentId1);
    ...
    public void btnUpdateOnAction(ActionEvent actionEvent) {
        ...
        double amount = Double.parseDouble(txtAmount.getText());
        try {
            String id1 = PaymentRepo.getId(date);
    ...
    public void btnGenerateReportOnAction(ActionEvent actionEvent) throws JRException, SQLException {
        ...
        Vehicle vehicle = VehicleRepo.getValues((comboVehicleId.getValue()));
